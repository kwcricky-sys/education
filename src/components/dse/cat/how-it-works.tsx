...
export function HowItWorks() {
  ...
  return (
    <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
      ...
      >
        <span>
          <span className="block text-xs font-semibold tracking-[0.18em] text-indigo-600 uppercase">
            How it works
          </span>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2">
                    <span className="flex size-7 items-center justify-center rounded-lg bg-white text-xs font-bold text-slate-400 ring-1 ring-slate-200">
                      {i + 1}
                    </span>
