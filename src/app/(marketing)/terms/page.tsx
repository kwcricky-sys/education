    ...
    <article className="mx-auto w-full max-w-3xl px-4 py-12 sm:px-6 sm:py-16">
      ...
      <div className="mt-8 space-y-6 text-sm leading-relaxed text-slate-600">
        <section className="space-y-2">
          <h2 className="text-lg font-semibold text-slate-900">1. 接受條款</h2>
          <p>
            使用 {SITE_NAME}
        ...
        <section className="space-y-2">
          <h2 className="text-lg font-semibold text-slate-900">2. 服務用途</h2>
          <p>
            本網站提供 DSE
        ...
        <section className="space-y-2">
          <h2 className="text-lg font-semibold text-slate-900">3. 免責聲明</h2>
          <p>{LEGAL_DISCLAIMER}</p>
        </section>

        <section className="space-y-2">
          <h2 className="text-lg font-semibold text-slate-900">4. 內容與知識產權</h2>
          <p>
